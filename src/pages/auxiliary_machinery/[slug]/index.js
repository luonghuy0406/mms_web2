...
const Page = ({products,subProducts}) => {
    ...
    return(
        <>
            ...
            <Product parentPath={'/auxiliary_machinery'} parentName={'Auxiliary Machinery'} product={product} subProducts={sub}/>
        </>
    )
};
...
Page.getInitialProps = async (ctx) => {
  ...
  return { products: json.results, subProducts: json2.results }
}
